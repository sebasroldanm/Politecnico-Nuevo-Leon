...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="text-center">
            <h3><span class="label label-danger"><asp:Label ID="L_AdminTituloConfig" runat="server"></asp:Label></span></h3>
        </div>
    </div>
    ...
    <div style="position: absolute; z-index: 1">
        <div class="auto-style1" style="margin: -535px 0px 0px 365px;">
            <div class="form-group">
                ...
                <div class="form-inline" role="form">
                    <label for="tb_correo" typeof="text" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminConfigCorreo" runat="server"></asp:Label></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
