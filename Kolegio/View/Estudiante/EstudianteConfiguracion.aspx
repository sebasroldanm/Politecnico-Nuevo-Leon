...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="text-center">
            <h3><span class="label label-danger"><asp:Label ID="L_EstuTituloConfig" runat="server"></asp:Label></span></h3>
        </div>
    </div>
        ...
        <div class="auto-style1" style="margin: -535px 0px 0px 365px;">
            <div class="form-group">
                ...
                <div class="form-inline" role="form">
                    <label for="tb_usuario" typeof="text" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_EstuConfigUsuario" runat="server"></asp:Label> &nbsp;&nbsp;&nbsp;&nbsp;</label>
                    ...
                    <label for="tb_contrasenia" typeof="text" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_EstuConfigContra" runat="server"></asp:Label></label>
                ...
                <div class="form-inline" role="form">
                    <label for="tb_correo" typeof="text" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_EstuConfigCorreo" runat="server"></asp:Label></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Label ID="lb_foto" for="tb_Foto" class="control-label" runat="server"  Style="color: #FFFFFF" Font-Bold="True"></asp:Label>
