...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        <div class="text-center">
            <h3><span class="label label-danger"><asp:Label ID="L_AdminAgreProTitulo" runat="server"></asp:Label></span></h3>
            <br />
        </div>
    </div>
    <div class="modal-body" style="margin: 0% 0% 0% 10%">
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                <label for="tb_DocenteId" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProDocumento" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_DocenteNombre" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProNombre" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProApellido" runat="server"></asp:Label></label>
        ...
        <br />
        <div class="form-inline" role="form">
            <label for="lugarnac1" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProDep" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_AdministradorFoto" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProFoto" runat="server"></asp:Label></label>
                ...
                <label for="fechanac" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProFechanac" runat="server"></asp:Label></label>
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                <label for="tb_DocenteCorreo" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProCorreo" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_DocenteDireccion" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_ADminAgreProDir" runat="server"></asp:Label></label>
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                <label for="tb_DocenteTelefono" class="control-label" style="color: #FFFFFF" id="lb_telefono"><asp:Label ID="L_AdminAgreProTel" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_DocenteUsuario" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProUser" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_DocenteContrasenia" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreProContra" runat="server"></asp:Label></label>
