    ...
    <div class="modal-body" style="margin: 0% 0% 0% 10%">
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_DocenteId" runat="server" ControlToValidate="tb_DocenteId" ErrorMessage="Digitar solo números" ValidationExpression="^[0-9]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm"></asp:RegularExpressionValidator>
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_nombre" runat="server" ControlToValidate="tb_DocenteNombre" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-z\sñÑ]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_" runat="server" ControlToValidate="tb_DocenteApellido" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-zñÑ\s]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_Correo" runat="server" ControlToValidate="tb_DocenteCorreo" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-z0-9ñÑ_@./]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_direccion" runat="server" ControlToValidate="tb_DocenteDireccion" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-z0-9ñÑ#,./\s]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
        </div>
        <br />
        <br />
        <div class="form-inline" role="form">
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_Telefono" runat="server" ControlToValidate="tb_DocenteTelefono" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-z0-9()-+\s]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_Usua" runat="server" ControlToValidate="tb_DocenteUsuario" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-z0-9ñÑ]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_Clave" runat="server" ControlToValidate="tb_DocenteContrasenia" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-z0-9ñÑ]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
            <div class="form-group">
