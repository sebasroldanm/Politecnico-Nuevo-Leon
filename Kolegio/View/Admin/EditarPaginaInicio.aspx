            ...
            <tr>
                <td class="auto-style2">
                    <label for="fechanac" class="control-label" style="color: #FFFFFF">
                        <asp:Label ID="L_AdminPagInicioFechaFin" runat="server"></asp:Label></label>
                ...
                <td>
                    <asp:Button ID="B_Terminaranio" runat="server" class="btn btn-success btn-lg" Width="141px" BorderColor="#660033" OnClick="B_Terminaranio_Click" ValidationGroup="form_ejm" />
                </td>
            </tr>
        </table>
