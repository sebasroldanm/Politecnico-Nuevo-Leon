    ...
    <ajaxToolkit:TabContainer ID="TC_Configuracion" runat="server" CssTheme="Plain" TabStripPlacement="TopRight" ActiveTabIndex="3">
            ...
            <HeaderTemplate>
                ...
                <div class="text-center">
                    <h4><span class="label label-success">
                        <asp:Label ID="L_AjaxTabSesion" runat="server"></asp:Label></span></h4>
                </div>
                ...
                <div class="container">
                    <div class="text-center">
                        <h3><span class="label label-danger">
                            <asp:Label ID="L_AjaxSubSesion" runat="server"></asp:Label></span></h3>
                    </div>
                ...
                <div class="container" style="margin: 0% 0% 0% 5%">
                    <div class="form-inline" role="form">
                        ...
                        <div class="form-group">
                            <label for="DDL_rolSession" class="control-label" style="color: #FFFFFF">
                        ...
                        <div class="form-group">
                            <label for="ddl_usuarioxrol" class="control-label" style="color: #FFFFFF">
                                <asp:Label ID="L_AjaxUsusarioxRol" runat="server"></asp:Label></label>

                            <label for="tb_usuario" class="control-label" style="color: #FFFFFF">
        ...
        <ajaxToolkit:TabPanel ID="TP_idioma" runat="server">
            <HeaderTemplate>
                ...
                <div class="text-center">
                    <h4><span class="label label-success">
                        <asp:Label ID="L_AjaxTabIdioma" runat="server"></asp:Label></span></h4>
                </div>
            ...
            <ContentTemplate>
                ...
                <div class="container">
                    ...
                    <div class="text-center">
                        <h3><span class="label label-danger">
                            <asp:Label ID="L_AjaxSubIdioma" runat="server"></asp:Label></span></h3>
                    </div>
                        ...
                        <ajaxToolkit:AccordionPane ID="AccordionPane1" runat="server">
                            ...
                            <Content>
                                ...
                                <div class="container" style="margin: 0% 0% 0% 5%">
                                    ...
                                    <div class="form-inline" role="form">
                                        <div class="form-group">
                                            <label for="DDL_rol" class="control-label" style="color: #333399">
                                        ...
                                        <div class="form-group">
                                            <label for="DDL_item" class="control-label" style="color: #333399">
                                        ...
                                        <div class="form-group">
                                            <label for="DDL_idioma" class="control-label" style="color: #333399">
                            ...
                            <Content>
                                ...
                                <div class="container" style="margin: 0% 0% 0% 5%">
                                    ...
                                    <div class="form-inline" role="form">
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox ID="TB_terminoidioma" MaxLength="6" runat="server" class="form-control" title="Terminacion en Visual" placeholder="Terminacion en Visual"></asp:TextBox>

                                            <asp:RequiredFieldValidator ID="RFV_TB_terminoidioma" runat="server" ControlToValidate="TB_terminoidioma" ValidationGroup="form_ejm3" ForeColor="Red" Font-Size="X-Large">*</asp:RequiredFieldValidator><br />
                                            <asp:RegularExpressionValidator ID="REV_TB_terminoidioma" runat="server" ControlToValidate="TB_terminoidioma" ValidationExpression="^[[a-zA-ZñÑ-]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" 
                                                ValidationGroup="form_ejm3" ErrorMessage ="No se aceptan Caracteres Especiales"></asp:RegularExpressionValidator>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV_TB_nomidioma" runat="server" ControlToValidate="TB_nomidioma" ValidationGroup="form_ejm3" ForeColor="Red" Font-Size="X-Large">*</asp:RequiredFieldValidator><br />
                                            <asp:RegularExpressionValidator ID="REV_TB_nomidioma" runat="server" ControlToValidate="TB_nomidioma" ValidationExpression="^[a-zA-Z0-9ñÑ,./\sáéíóú]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" 
                                                ValidationGroup="form_ejm3" ErrorMessage ="No se aceptan Caracteres Especiales"></asp:RegularExpressionValidator>
                                        </div>
                                        <div class="form-group">
                                            <asp:Button ID="btn_comprobaridiom" runat="server" class="btn btn-primary btn-lg" Width="141px" BorderColor="#660033" OnClick="btn_comprobaridiom_Click" ValidationGroup="form_ejm3"/>
                                        </div>

                                        <div class="form-group">
                                            <label for="DDL_rolagregar" class="control-label" style="color: #333399">
                                        ...
                                        <div class="form-group">
                                            <label for="DDL_formularioagregar" class="control-label" style="color: #333399">
                                                <asp:Label ID="L_AjaxAcorDDLFormAgregar" runat="server"></asp:Label></label>
                                        ...
                                        <div class="form-group">
                                            <label for="DDL_itemagregar" class="control-label" style="color: #333399">
                                                <asp:Label ID="L_AjaxAcorDDLItemAgregar" runat="server"></asp:Label></label>
                                    ...
                                    <div class="form-inline" role="form">
                                        ...
                                        <asp:TextBox ID="tb_traduccion" MaxLength="40" runat="server" class="form-control" title="Traducción" ReadOnly="true"  TextMode="MultiLine"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RFV_tb_traduccion" runat="server" ControlToValidate="tb_traduccion" ValidationGroup="boton_siguiente" ForeColor="Red" Font-Size="X-Large">*</asp:RequiredFieldValidator><br />
                                            <asp:RegularExpressionValidator ID="REV_tb_traduccion" runat="server" ControlToValidate="tb_traduccion" ValidationExpression="^[a-zA-Z0-9ñÑ,./\sáéíóú]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" 
                                                ValidationGroup="boton_siguiente" ErrorMessage ="No se aceptan Caracteres Especiales"></asp:RegularExpressionValidator>
                                    ...
                                    <div class="form-inline container">
                                        <asp:Button ID="btn_siguiente" runat="server" class="btn btn-info btn-lg" Width="141px" BorderColor="#660033" OnClick="btn_siguiente_Click" Visible="false" ValidationGroup="boton_siguiente"/>
        ...
        <ajaxToolkit:TabPanel ID="TP_sesiones" runat="server">
            <HeaderTemplate>
                <div class="text-center">
                    <h4><span class="label label-success">
                        <asp:Label ID="L_AjaxConfingLeon" runat="server"></asp:Label></span></h4>
                </div>
                    ...
                    <table class="nav-justified">
                        <tr>
                            <td class="auto-style2">
                                ...
                                <asp:RequiredFieldValidator ID="RFV_Nosotros" runat="server" ControlToValidate="TB_Nosotros" ErrorMessage="Campo Vacio" CssClass="label-danger" ForeColor="White" Font-Bold="True" SetFocusOnError="True" ValidationGroup="vacio">*</asp:RequiredFieldValidator><br />
                                <br />
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RFV_Mision" runat="server" ControlToValidate="TB_Mision" ErrorMessage="Campo Vacio" CssClass="label-danger" ForeColor="White" Font-Bold="True" SetFocusOnError="True" ValidationGroup="vacio">*</asp:RequiredFieldValidator><br />
                                <br />
                        ...
                        <tr>
                            <td class="auto-style2">
                                <label for="TB_Vision" class="control-label" style="color: #FFFFFF">
                                    <asp:Label ID="L_AdminPagInicioVision" runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                                </label>
                                &nbsp;<asp:TextBox ID="TB_Vision" class="form-control" runat="server" Width="370px" TextMode="MultiLine" Height="100px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RFV_Vision" runat="server" ControlToValidate="TB_Vision" ErrorMessage="Campo Vacio" CssClass="label-danger" ForeColor="White" Font-Bold="True" SetFocusOnError="True" ValidationGroup="vacio">*</asp:RequiredFieldValidator><br />
                                <br />
                                <asp:RegularExpressionValidator ID="REV_Vision" runat="server" ControlToValidate="TB_Vision" ValidationExpression="^[a-zA-z0-9ñÑ,.\s\n()áéíóú]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="mod"></asp:RegularExpressionValidator></td>
                            <td>
                                <asp:Button ID="B_Modificar" runat="server" class="btn btn-success btn-lg" Width="141px" BorderColor="#660033" OnClick="B_Modificar_Click" CausesValidation="True" Visible="False" />
                                <asp:Button ID="B_Traer" runat="server" BorderColor="#660033" OnClick="B_Traer_Click" class="btn btn-info btn-lg" ValidationGroup="mod" />
