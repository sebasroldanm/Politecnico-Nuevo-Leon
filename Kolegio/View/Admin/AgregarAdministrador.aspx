    ...
    <div class="modal-body" style="margin: 0% 0% 0% 10%">
        <div class="form-inline" role="form">
            <div class="form-group">
                ...
                <asp:RangeValidator ID="RV_id_Administrador" runat="server" ControlToValidate="tb_AministradorAdministradorId" CssClass="label-warning" ErrorMessage="Sobrepasó el limite" Font-Bold="True" ForeColor="White" MaximumValue="999999999" MinimumValue="1" ValidationGroup="form_ejm3"></asp:RangeValidator><br />
            </div>
            <div class="form-group">
