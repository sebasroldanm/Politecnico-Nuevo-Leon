...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        <div class="text-center">
            <h3><span class="label label-danger"><asp:Label ID="L_AdminAgreAcuTitulo" runat="server"></asp:Label></span></h3>
            <br />
        </div>
    </div>
    <div class="modal-body" style="margin: 0% 0% 0% 10%">
        <div class="form-inline" role="form">
            <div class="form-group">
                <label for="tb_AcudienteId" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuDocumento" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_AcudienteNombre" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuNombre" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuApellido" runat="server"></asp:Label></label>
        ...
        <div class="form-inline" role="form">
            ...
            <label for="lugarnac1" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuDep" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_Foto" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuFoto" runat="server"></asp:Label></label>
                ...
                <label for="fechanac" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuFechanac" runat="server"></asp:Label></label>
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                <label for="tb_AcudienteCorreo" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuCorreo" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_AcudienteDireccion" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_ADminAgreAcuDir" runat="server"></asp:Label></label>
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                <label for="tb_AcudienteTelefono" class="control-label" style="color: #FFFFFF" id="lb_telefono"><asp:Label ID="L_AdminAgreAcuTel" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_AcudienteUsuario" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuUser" runat="server"></asp:Label></label>
            ...
            <div class="form-group">
                <label for="tb_AcudienteContrasenia" class="control-label" style="color: #FFFFFF"><asp:Label ID="L_AdminAgreAcuContra" runat="server"></asp:Label></label>
