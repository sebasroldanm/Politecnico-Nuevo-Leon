    ...
    <div class="modal-body" style="margin: 0% 0% 0% 10%">
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_AministradorAdministradorId" runat="server" ControlToValidate="tb_AministradorAdministradorId" ErrorMessage="Digitar solo números" ValidationExpression="^[0-9]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm"></asp:RegularExpressionValidator>
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_apellido" runat="server" ControlToValidate="tb_AdministradorAdministradorApellido" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-Z0-9ñ\sÑ]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
        ...
        <div class="form-inline" role="form">
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_orreo" runat="server" ControlToValidate="tb_AdministradorAdministradorCorreo" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-Z0-9ñÑ_@./]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
            <div class="form-group">
        ...
        <div class="form-inline" role="form">
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_telefono" runat="server" ControlToValidate="tb_AdministradorTelefono" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-z0-9()-+\s]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="REV_usuario" runat="server" ControlToValidate="tb_AdministradorUsuario" ErrorMessage="No se aceptan caracteres especiales" ValidationExpression="^[a-zA-Z0-9ñÑ]*$" CssClass="label-warning" Font-Bold="True" ForeColor="White" ValidationGroup="form_ejm2"></asp:RegularExpressionValidator>
            </div>
