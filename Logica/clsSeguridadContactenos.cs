...
{
    public class clsSeguridadContactenos : System.Web.Services.Protocols.SoapHeader
    {
        ...
        public bool blCredencialesValidas(clsSeguridadContactenos SoapHeader)
        {
            try
            {
                if (SoapHeader == null)
